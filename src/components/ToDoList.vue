<template>
  <div class="container shadow-lg px-5 py-5 rounded-3">
    <h1 class="mb-5">Ma To Do List</h1>
    ...
    >
      <div class="col-7 text-start">
        <h5 :class="{ 'todo-finished': todo.status === 'Terminé' }">
          {{ todo.name }}
        </h5>
      </div>
      <div class="col-2">
        <div class="d-flex justify-content-start align-items-center">
          <div
            ...
            :class="{
              'status-indicator-todo': todo.status === 'À faire',
              'status-indicator-ongoing': todo.status === 'En cours',
              'status-indicator-finished': todo.status === 'Terminé',
            }"
          ></div>
          <div
            class="status-text"
            ...
            :class="{
              'status-text-todo': todo.status === 'À faire',
...
export default {
  ...
  data() {
    return {
      ...
      tempNameTodo: "",
      tempStatusTodo: "",
      todoStatus: ["À faire", "En cours", "Terminé"],
      todos: [
      ],
    };
  },
